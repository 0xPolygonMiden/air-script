...
impl Air for SelectorsAir {
    ...
    fn new(trace_info: TraceInfo, public_inputs: PublicInputs, options: WinterProofOptions) -> Self {
        let main_degrees = vec![TransitionConstraintDegree::new(2), TransitionConstraintDegree::new(2), TransitionConstraintDegree::new(2), TransitionConstraintDegree::new(3)];
        let aux_degrees = vec![];
    ...
    fn evaluate_transition<E: FieldElement<BaseField = Felt>>(&self, frame: &EvaluationFrame<E>, periodic_values: &[E], result: &mut [E]) {
        ...
        result[0] = main_current[3] * (main_next[0] - (main_current[0] + main_current[1])) - E::ZERO;
        result[1] = main_current[3] * (main_next[1] - main_current[2]) - E::ZERO;
        result[2] = (E::ONE - main_current[3]) * (main_next[1] - main_current[2]) - E::ZERO;
        result[3] = (E::ONE - main_current[3]) * (main_next[0] - main_current[0] * main_current[1]) - E::ZERO;
    }
