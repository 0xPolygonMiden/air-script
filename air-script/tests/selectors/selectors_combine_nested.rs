...
impl Air for SelectorsAir {
    ...
    fn new(trace_info: TraceInfo, public_inputs: PublicInputs, options: WinterProofOptions) -> Self {
        let main_degrees = vec![TransitionConstraintDegree::new(4), TransitionConstraintDegree::new(3), TransitionConstraintDegree::new(3), TransitionConstraintDegree::new(4)];
        let aux_degrees = vec![];
    ...
    fn evaluate_transition<E: FieldElement<BaseField = Felt>>(&self, frame: &EvaluationFrame<E>, periodic_values: &[E], result: &mut [E]) {
        ...
        result[0] = main_current[0] * (main_current[5] - E::from(Felt::new(20_u64))) + (E::ONE - main_current[0]) * main_current[1] * main_current[3] * (main_current[3] - E::ONE) + (E::ONE - main_current[0]) * (E::ONE - main_current[1]) * (main_current[4] - E::from(Felt::new(5_u64)));
        result[1] = (E::ONE - main_current[0]) * main_current[1] * (main_current[4] - E::from(Felt::new(31_u64)));
        result[2] = (E::ONE - main_current[0]) * main_current[1] * (main_current[5] - E::from(Felt::new(5_u64)));
        result[3] = (E::ONE - main_current[0]) * main_current[1] * (main_current[3] * (main_next[4] - (main_current[4] + E::ONE)) + (E::ONE - main_current[3]) * (main_next[4] - main_current[4]));
    }
