...
use crate::{
    constraint_comprehension::constraint_comprehension_plonky3::{
        ConstraintComprehensionAir, NUM_COLUMNS,
    },
...
fn test_air_plonky3() {
    ...
    check_constraints_with_periodic_columns(&ConstraintComprehensionAir {}, &trace, &inputs_m31);
}
