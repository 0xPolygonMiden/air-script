...
impl<AB: AirBuilderWithPublicValues + AirBuilderWithPeriodicColumns> Air<AB> for ConstraintComprehensionAir {
    fn eval(&self, builder: &mut AB) {
        ...
        builder.assert_zero::<_>(main_current[6] - main_current[10]);
        builder.assert_zero::<_>(main_current[7] - main_current[11]);
        builder.assert_zero::<_>(main_current[8] - main_current[12]);
        builder.assert_zero::<_>(main_current[9] - main_current[13]);
    }
}