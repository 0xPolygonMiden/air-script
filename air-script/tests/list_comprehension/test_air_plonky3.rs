...
use crate::{
    ...
    list_comprehension::list_comprehension_plonky3::{ListComprehensionAir, NUM_COLUMNS},
};
...
fn test_air_plonky3() {
    ...
    check_constraints_with_periodic_columns(&ListComprehensionAir {}, &trace, &inputs_m31);
}
