...
impl<AB: AirBuilderWithPublicValues + AirBuilderWithPeriodicColumns> Air<AB> for ListComprehensionAir {
    fn eval(&self, builder: &mut AB) {
        ...
        builder.assert_zero::<_>(main_current[0] + main_current[1] * AB::Expr::from(AB::F::from_u64(2)) - AB::Expr::from(AB::F::from_u64(3)));
        builder.assert_zero::<_>(main_current[0] * AB::Expr::from(AB::F::from_u64(2)) + main_current[1] * AB::Expr::from(AB::F::from_u64(3)) - AB::Expr::from(AB::F::from_u64(5)));
        builder.assert_zero::<_>(main_current[0] * AB::Expr::from(AB::F::from_u64(3)) + main_current[1] * AB::Expr::from(AB::F::from_u64(4)) - AB::Expr::from(AB::F::from_u64(7)));
    }
}