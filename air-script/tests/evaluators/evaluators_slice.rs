...
impl Air for EvaluatorsSliceAir {
    ...
    fn evaluate_transition<E: FieldElement<BaseField = Felt>>(&self, frame: &EvaluationFrame<E>, periodic_values: &[E], result: &mut [E]) {
        ...
        result[1] = main_current[0] * (main_current[1] * main_current[1] - main_current[1]);
        result[2] = main_current[0] * main_current[1] * (main_current[2] * main_current[2] - main_current[2]);
        result[3] = main_current[0] * main_current[1] * main_current[2] * (main_current[3] * main_current[3] - main_current[3]);
        result[4] = main_current[0] * main_current[1] * main_current[2] * main_current[3] * (main_current[4] * main_current[4] - main_current[4]);
    }
