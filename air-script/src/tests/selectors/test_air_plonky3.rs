...
use crate::{
    ...
    tests::selectors::selectors_with_evaluators_plonky3::{MAIN_WIDTH, SelectorsAir},
};
...
generate_air_plonky3_test_with_airscript_traits!(test_air_plonky3, SelectorsAir);
