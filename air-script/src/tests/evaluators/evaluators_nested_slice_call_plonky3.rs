...
impl<F, EF> MidenAir<F, EF> for EvaluatorsSliceAir {
    ...
    where AB: MidenAirBuilder<F = F>,
    {
        ...
        builder.assert_zero(main_current[5].clone().into() * (main_current[6].clone().into() * main_current[6].clone().into() - main_current[6].clone().into()));
        builder.assert_zero(main_current[5].clone().into() * main_current[6].clone().into() * (main_current[7].clone().into() * main_current[7].clone().into() - main_current[7].clone().into()));
