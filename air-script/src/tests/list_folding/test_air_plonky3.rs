...
use crate::{
    ...
    tests::list_folding::list_folding_plonky3::{ListFoldingAir, MAIN_WIDTH},
};
...
generate_air_plonky3_test_with_airscript_traits!(test_air_plonky3, ListFoldingAir);
