...
impl<F: Field, AB: AirScriptBuilder<F = F>> AirScriptAir<F, AB> for BusesAir {
    ...
    fn eval(&self, builder: &mut AB) {
        ...
        builder.when_transition().assert_zero_ext(((beta.into() + alpha_challenges[0].into()) * AB::ExprEF::from(main_current[0].clone().into()) + AB::ExprEF::ONE - AB::ExprEF::from(main_current[0].clone().into())) * AB::ExprEF::from(aux_current[0].clone().into()) - ((beta.into() + alpha_challenges[0].into()) * (AB::ExprEF::ONE - AB::ExprEF::from(main_current[0].clone().into())) + AB::ExprEF::from(main_current[0].clone().into())) * AB::ExprEF::from(aux_next[0].clone().into()));
        builder.when_transition().assert_zero_ext((beta.into() + alpha_challenges[0].into() + alpha_challenges[1].into().double()) * (beta.into() + alpha_challenges[0].into() + alpha_challenges[1].into().double()) * AB::ExprEF::from(aux_current[1].clone().into()) + (beta.into() + alpha_challenges[0].into() + alpha_challenges[1].into().double()) * AB::ExprEF::from(main_current[0].clone().into()) - ((beta.into() + alpha_challenges[0].into() + alpha_challenges[1].into().double()) * (beta.into() + alpha_challenges[0].into() + alpha_challenges[1].into().double()) * AB::ExprEF::from(aux_next[1].clone().into()) + (beta.into() + alpha_challenges[0].into() + alpha_challenges[1].into().double()).double()));
    }
}
