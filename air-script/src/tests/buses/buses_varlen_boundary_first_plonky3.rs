...
impl BusesAir {
          ...
          EF: ExtensionField<F>,
    {
        ...
        let result = (challenges[0] + challenges[1] * EF::ONE) * (EF::from(main_current[0].clone()) - EF::ONE) + (EF::ONE - (EF::from(main_current[0].clone()) - EF::ONE));
        if result == EF::ZERO {
            return EF::ONE;
        }
        result
          ...
          EF: ExtensionField<F>,
    {
        ...
        let _periodic_values: [_; NUM_PERIODIC_VALUES] = periodic_evals.try_into().expect("Wrong number of periodic values");
        (challenges[0] + challenges[1] * EF::ONE + challenges[2] * EF::from_u64(2)) * (challenges[0] + challenges[1] * EF::ONE + challenges[2] * EF::from_u64(2)) * (challenges[0] + challenges[1] * EF::ONE + challenges[2] * EF::from_u64(2))
    }
          ...
          EF: ExtensionField<F>,
    {
        ...
        let _periodic_values: [_; NUM_PERIODIC_VALUES] = periodic_evals.try_into().expect("Wrong number of periodic values");
        let terms_added = EF::from(main_current[0].clone()) * (challenges[0] + challenges[1] * EF::ONE + challenges[2] * EF::from_u64(2)) * (challenges[0] + challenges[1] * EF::ONE + challenges[2] * EF::from_u64(2)) + EF::from(main_current[0].clone()) * (challenges[0] + challenges[1] * EF::ONE + challenges[2] * EF::from_u64(2)) * (challenges[0] + challenges[1] * EF::ONE + challenges[2] * EF::from_u64(2));
        let terms_removed = EF::from_u64(2) * (challenges[0] + challenges[1] * EF::ONE + challenges[2] * EF::from_u64(2)) * (challenges[0] + challenges[1] * EF::ONE + challenges[2] * EF::from_u64(2));
