...
impl Air for BusesAir {
    ...
    fn new(trace_info: TraceInfo, public_inputs: PublicInputs, options: WinterProofOptions) -> Self {
        ...
        let aux_degrees = vec![TransitionConstraintDegree::new(5), TransitionConstraintDegree::new(3)];
