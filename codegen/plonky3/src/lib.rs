...
/// CodeGenerator is used to generate a Rust implementation of the Plonky3 STARK prover library's
...
impl air_ir::CodeGenerator for CodeGenerator {
    ...
    fn generate(&self, ir: &Air) -> anyhow::Result<Self::Output> {
        ...
        // add an Air struct and plonky3 Air trait implementation for the provided AirIR.
